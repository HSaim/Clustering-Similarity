...
public class TopicModel {
	public static final String FILES_TO_INDEX_DIRECTORY="Outfile\\out.txt";   //Output File i.e. resulting domain
	public static final String Compile_Code_Directory ="Outfile\\Output.txt"; //Input File i.e. feature list
